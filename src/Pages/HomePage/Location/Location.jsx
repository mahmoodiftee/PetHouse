                ...
                <div className="mx-auto max-w-7xl px-2 md:px-6">
                    ...
                    <div className="mx-auto grid grid-cols-1 gap-10 lg:grid-cols-2">
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
                            {
                                cards.map((card) =>
                                    <button onClick={() => handleLocation(card.position, card.details)} key={card.id} className="flex bg-dark bg-opacity-[90%] py-5 px-3 rounded-xl flex-col items-start">
                                        ...
                                        <dt className="mt-2 font-semibold text-white">{card.location}</dt>
