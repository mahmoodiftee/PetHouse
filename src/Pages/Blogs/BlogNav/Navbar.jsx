            ...
            <div className="w-full flex items-center justify-between gap-2 max-w-md px-2 sm:px-0">
                ...
                <div className="w-56 text-right">
                    <Menu as="div" className="relative inline-block text-left">
                        <div>
                            <Menu.Button className="inline-flex w-full justify-center rounded-md bg-[#202020] px-4 py-2 text-sm font-medium text-white hover:bg-[#202020] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2c2c2c]">
                                Categories
                                <ChevronDownIcon
                                    ...
                                    <Menu.Item>
                                        {({ active }) => (
                                            <button
                                                ...
                                                className={`${active ? 'bg-gray-300 text-white' : 'text-white'
