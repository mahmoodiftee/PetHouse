    ...
    return (
        <div className="w-full ">
            <input
                ...
                className="rounded-lg w-full bg-[#202020]  border-[#2c2c2c] px-4 mb-2 py-2 text-left text-sm font-medium text-gray-300 hover:bg-[#202020] border-0 focus:ring-orange"
            />
